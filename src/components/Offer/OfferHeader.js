...
const OfferHeader = (props) => {
  ...
  return (
    <View style={[{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start'}, props.style]}>
      <Icon size={60} name={props.subject.icon} color={colors.primary} style={{paddingHorizontal: 15}} />
